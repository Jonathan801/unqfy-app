...
describe('Add, remove and filter data', () => {
  ...
  //   const album1 = createAndAddAlbum(unqfy, artist2.id, 'Appetite for Destruction', 1987);
  ...
  //   const t2_1 =createAndAddTrack(unqfy, album2.id, 'Another song', 500, ['classic']);
  //   const t3 = createAndAddTrack(unqfy, album2.id, 'Another song II', 500, ['movie']);

  //   unqfy.getTracksMatchingArtist('Michael Jackson');
